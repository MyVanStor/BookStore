...
public class Test {
	public static void main(String[] args) throws Exception {
		...
		RatingDao.getInstance().save(rating1);
		RatingDao.getInstance().save(rating2);
		...
		publishingHouse.setAddress("Đống đa, Hà Nội");
		publishingHouse.setBook(book);
		publishingHouse.setEmail("vanhoa@gmail.com");
		publishingHouse.setName("NXB Đống đa");
		publishingHouse.setPhone("03333333");
